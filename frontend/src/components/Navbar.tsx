...
export const Navbar: React.FC = () => {
  ...
  return (
    <div className="py-6 layout tracking-wider flex flex-row justify-between">
      ...
      <div className="hidden md:flex items-center text-center px-6 md:px-8 max-w-5xl mx-auto">
        <ul className="w-full gap-8 flex flex-row items-center justify-between">
